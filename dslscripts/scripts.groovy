...
mavenJob('job-dsl-compile'){
  ...
  customWorkspace('/home/coroot/.jenkins/workspace/job-dsl-checkout')
...
job('job-dsl-deploy') {
    ...
    steps{
             shell 'sshpass -p "Default3044" scp /home/coroot/.jenkins/workspace/job-dsl-checkout/target/hello-world-war-1.0.0.war release@10.12.108.11:/opt/apache-tomcat-9.0.65/webapps/'
      }
}
